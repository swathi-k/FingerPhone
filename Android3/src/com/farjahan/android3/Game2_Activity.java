...
public class Game2_Activity extends Activity 
   ...
   protected void onCreate(Bundle savedInstanceState) {
	...
	private void init(){
		...
		textHigh=(TextView)findViewById(R.id.game2HighScore2);
	...
	/*private String getRandomOrientation(){
		final String[] arr = { "Brush", "notBrushed" };
		Random random = new Random();
	...
	*/
	...
	private void showMessage(){
		...
		textHigh.setText(getString(R.string.text_high_score2)+ " "+highScore);
   	       ...
   	       */
   	   	...
   	   	if(!clickDone){
   			...
   			//check if the player hit the right orientation
	    		...
	    		if(current==Configuration.ORIENTATION_PORTRAIT && orientation==PORTRAIT) {
	    			view.setImageResource(R.drawable.portrait_wake_up);
	    			...
	    			view.setImageResource(R.drawable.landscape_wake_up);
